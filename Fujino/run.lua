...
function init_gear_sets()
    ...
    sets.EnmityBoost = {
        ...
        right_ear={ name="オノワイヤリング+1", hp=150,},
    ...
    sets.precast.FC = {
        ...
        feet={ name="カマイングリーヴ+1", augments={'Accuracy+12','DEX+12','MND+20',}, fc=0.08, hp=95,},
        ...
        right_ring={ name="月光の指輪", hp=110,},
        back={ name="オーグマケープ", augments={'HP+60','Eva.+20 /Mag. Eva.+20','Mag. Evasion+10','Enmity+10','Damage taken-5%',}, fc=0.1, hp=80},
    }
    ...
    sets.precast.WS.dex = {
        ...
        right_ear="シェリダピアス",
        left_ring="ニックマドゥリング",
        right_ring={ name="エパミノダスリング", hp=60,},
        back={ name="オーグマケープ", augments={'DEX+20','Accuracy+20 Attack+20','Weapon skill damage +10%',}},
    }
    ...
    sets.precast.JA['エンボルド'] = {back={ name="ディバートケープ", augments={'Enmity+4','"Embolden"+15','"Dbl.Atk."+1','Damage taken-2%',}},}
    sets.precast.JA['ビベイシャス'] = {head={ name="ＥＲガレア+1", hp=91,}}
    sets.precast.JA['ガンビット'] = set_combine(sets.EnmityBoost, {hands={ name="ＲＮミトン+1", hp=85,}})
    ...
    sets.precast.JA['ワンフォアオール'] = {
        ...
        hands={ name="ＲＮミトン+1", hp=85,},
        legs={ name="カマインクウィス+1", augments={'Accuracy+20','Attack+12','"Dual Wield"+6',}, hp=130},
        feet={ name="カマイングリーヴ+1", augments={'Accuracy+12','DEX+12','MND+20',}, fc=0.08, hp=95,},
        neck={ name="フサルクトルク+2", hp=60,},
    ...
    sets.midcast['強化魔法']['ファランクス'] = {
        ...
        body={ name="テーオンタバード", augments={'Phalanx +3',}, hp=61,},
        hands={ name="テーオングローブ", augments={'Phalanx +3',}, hp=20,},
        legs={ name="テーオンタイツ", augments={'Phalanx +3',}, hp=38,},
        feet={ name="テーオンブーツ", augments={'Spell interruption rate down -10%','Phalanx +3',}, hp=9,},
        neck={ name="フサルクトルク+2", hp=60,},
        waist="オリンポスサッシュ",
        left_ear={ name="エテオレートピアス", hp=50,},
        right_ear={ name="トゥイストピアス", hp=150,},
    ...
    sets.midcast.sird = {
        ...
        legs={ name="カマインクウィス+1", augments={'Accuracy+20','Attack+12','"Dual Wield"+6',}, hp=130},
        feet={ name="テーオンブーツ", augments={'Spell interruption rate down -10%','Phalanx +3',}, hp=63,},
        neck="月光の首飾り",
        waist="オドンブラサッシュ",
        left_ear="ハラサズピアス",
        right_ear="磁界の耳",
    ...
    sets.midcast['強化魔法']['エンボルド'] = {back={ name="ディバートケープ", augments={'Enmity+4','"Embolden"+15','"Dbl.Atk."+1','Damage taken-2%',}},}
    ...
    sets.idle = {
        sub="コーンスー",
        ammo="ヤメラング",
        head={ name="ＲＮバンド+3", hp=91,},
        body={ name="ＲＮコート+3", hp=218,},
        hands={ name="トゥルムミトン+1", hp=74,},
        legs={ name="ＦＵトラウザ+3", hp=114,},
...
function job_self_command(cmdParams, eventArgs)
    ...
    elseif cmdParams[1] == 'phalanx' then
        ...
        if buffactive['エンボルド'] then
            set_equip = set_combine(set_equip, {back={ name="ディバートケープ", augments={'Enmity+4','"Embolden"+15','"Dbl.Atk."+1','Damage taken-2%',}},})
        end
        equip(set_equip)
        set_priorities_by_hp()
    end
