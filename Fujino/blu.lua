...
function init_gear_sets()
  ...
  sets.weapons.Sequence = {main={name="セクエンス"}, sub={name="ネイグリング"},}
  sets.weapons.Magic = {main={ name="ブンジロッド", augments={'Path: A',}}, sub={name="マクセンチアス"},}
  sets.weapons.Club = {main={name="ネイグリング"}, sub={name="マクセンチアス"},}
  ...
  sets.EnmityBoost = {
      ...
      --body="エメットハーネス+1",
      body={ name="ＡＭダブレット+1", bag={'wardrobe',}},
      hands="マリグナスグローブ",
      legs="マリグナスタイツ",
      --feet="アホシレギンス",
  ...
  sets.midcast.cure = {
      ...
      body="ピンガチュニック+1",
      --hands="ＨＳバズバンド+1",
      hands={ name="テルキネグローブ", bag={'wardrobe 7',}},
      --legs="ギーヴトラウザ",
      legs="ピンガズボン+1",
      --feet={ name="ミディアムサボ", augments={'MP+45','MND+9','"Conserve MP"+5','"Cure" potency +4%',}},
      feet={ name="テルキネピガッシュ", bag={'wardrobe 7',}},
      --neck="ファライナロケット",
      waist="ギシドゥバサッシュ",
      left_ear="オノワイヤリング+1",
      right_ear="メンデカントピアス",
  ...
  sets.midcast['青魔法'].MagicEarth = set_combine(sets.midcast.magic, {neck="サンクトネックレス",})
  ...
  sets.midcast['強化魔法']['ファランクス'] = {
      ammo="ストンチタスラム+1",
      head={ name="テーオンシャポー", bag={'wardrobe 8',}},
      body={ name="テーオンタバード", bag={'wardrobe 8',}},
      hands={ name="テーオングローブ", bag={'wardrobe 8',}},
      legs={ name="テーオンタイツ", bag={'wardrobe 8',}},
      feet={ name="テーオンブーツ", bag={'wardrobe 8',}},
      waist="オリンポスサッシュ",
