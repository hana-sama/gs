...
function job_setup()
    ...
    state.Buff['グローリーブレイズ'] = buffactive['グローリーブレイズ'] or false
    ...
    degrade_array = {
        ['Fire'] = {'ファイア','ファイアII','ファイアIII','ファイアIV','ファイアV'},
        ['Ice'] = {'ブリザド','ブリザドII','ブリザドIII','ブリザドIV','ブリザドV'},
        ['Wind'] = {'エアロ','エアロII','エアロIII','エアロIV','エアロV'},
        ['Earth'] = {'ストーン','ストーンII','ストーンIII','ストーンIV','ストーンV'},
        ['Lightning'] = {'サンダー','サンダーII','サンダーIII','サンダーIV','サンダーV'},
        ['Water'] = {'ウォータ', 'ウォータII','ウォータIII', 'ウォータIV','ウォータV'},
        ['Aspirs'] = {'アスピル','アスピルII','アスピルIII'},
        }
...
function init_gear_sets()
    ...
    sets.precast.JA.Bolster = {body="ＢＡチュニック+3"}
    sets.precast.JA['フルサークル'] = {head="ＡＺフード+1"}
    sets.precast.JA['ライフサイクル'] = {head="Bagua Galero +3", body="ＧＯチュニック+3", back=gear.GEO_Idle_Cape,}
    ...
    sets.precast.FC['精霊魔法'] = set_combine(sets.precast.FC, {hands="ＢＡミテーヌ+3"})
    ...
    sets.precast.FC.Impact = set_combine(sets.precast.FC, {head=empty, body="トワイライトプリス"})
    ...
    sets.precast.WS['エクズデーション'] = sets.precast.WS['ヘキサストライク']

    sets.precast.WS['フラッシュノヴァ'] = {
        head="Bagua Galero +3",
        body="ＡＭタブレット+1",
        hands="ＡＭゲージ+1",
        legs="ＡＭスロップス+1",
