...
function user_setup()
  ...
  state.Weapons = M{['description']='Use Weapons', 'Toret'}
...
function init_gear_sets()
  ...
  sets.weapons.Toret = {main="トーレット", sub={ name="マレヴォレンス", bag={'wardrobe 7',}}}
  ...
  sets.precast.WS.magic = {
      ...
      --feet={ name="ニャメソルレット", augments={'Path: B',}},
      --feet={ name="ヘルクリブーツ", augments={'STR+3','"Mag.Atk.Bns."+25','Accuracy+14 Attack+14','Mag. Acc.+16 "Mag.Atk.Bns."+16',}},
