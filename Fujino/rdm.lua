...
function init_gear_sets()
  ...
  d1_dw = {main={name="クトゥルブナイフ"}, sub={name="アーンダガー",},}

  crocea_c = {main={ name="クロセアモース", augments={'Path: C',}}, sub={name="ＢＦバルワク+1",},}
  --crocea_b = {main={ name="クロセアモース", augments={'Path: B',}}, sub={name="ＢＦバルワク+1",},}
  crocea_c_daybreak = {main={ name="クロセアモース", augments={'Path: C',}}, sub={name="ＢＦバルワク+1",},}
  crocea_c_levante = {main={ name="クロセアモース", augments={'Path: C',}}, sub={name="ＢＦバルワク+1",},}
  daybreak = {main={name="デイブレイクワンド"}, sub={name="ＢＦバルワク+1",},}
  maxentius =  {main={name="マクセンチアス"}, sub={name="ＢＦバルワク+1",},}
  tauret = {main={name="トーレット"}, sub={name="ＢＦバルワク+1",},}
  mandau = {main={name="マンダウ"}, sub={name="ＢＦバルワク+1",},}
  d1 = {main={name="クトゥルブナイフ"}, sub={name="ＢＦバルワク+1",},}
  ...
  sets.TreasureHunter = {
      head="白ララブキャップ+1",
      --legs={ name="マーリンクラッコー", augments={'"Mag.Atk.Bns."+17','Pet: "Dbl. Atk."+2','"Treasure Hunter"+2','Accuracy+8 Attack+8',}},
  ...
  sets.midcast.phalanx_self = {
      ...
      --head={ name="テーオンシャポー", augments={'Phalanx +3','Accuracy+22','"Triple Atk."+2','DEX+10',}},
  ...
  sets.midcast['強化魔法'].Protect = set_combine(sets.midcast['強化魔法'], {right_ear="エテオレートピアス",})
  sets.midcast['強化魔法'].Protect_Others = sets.midcast['強化魔法'].Others
  sets.midcast['強化魔法'].Shell = set_combine(sets.midcast['強化魔法'], {right_ear="エテオレートピアス",})
  ...
  sets.idle.Refresh = set_combine(sets.idle, {body="ケカスブリオー+1",})
  ...
  sets.engaged = {
      ...
      right_ring={name="シーリチリング+1", bag="Wardrobe 7"},
