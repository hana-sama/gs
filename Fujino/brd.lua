...
function job_setup()
    ...
    init_song_spell_map()
    set_dummy_song('小話のオペレッタ')
    set_dummy_song('ゴブリンのガボット')
    set_dummy_song('光明のファンタジア')
    set_dummy_song('黄金のカプリチオ')
    set_dummy_song('腹話のオペレッタ')
...
function init_gear_sets()
    sets.Linos_melee = {range={ name="リノス", augments={'Accuracy+17','"Dbl.Atk."+3','Quadruple Attack +3',}},}
    ...
    sets.precast.FC = {
        ...
        legs="アヤモコッシャレ+2",
        feet={ name="テルキネピガッシュ", bag={'wardrobe 5',}},
        neck="ボルトサージトルク",
        waist="ジーゲルサッシュ",
        left_ear="エンチャンピアス+1",
        right_ear="ロケイシャスピアス",
    ...
    sets.midcast['強化魔法'] = {
        sub="アムラピシールド",
        head={ name="テルキネキャップ", bag={'wardrobe 5',}},
        body={ name="テルキネシャジュブ", bag={'wardrobe 5',}},
        hands={ name="テルキネグローブ", bag={'wardrobe 5',}},
        legs={ name="テルキネブラコーニ", bag={'wardrobe 5',}},
        feet={ name="テルキネピガッシュ", bag={'wardrobe 5',}},
        neck="ボルトサージトルク",
        waist="フルームベルト+1",
        left_ear="エテオレートピアス",
    ...
    sets.midcast['BardSong'].Minne      = set_combine(sets.midcast.song_base, {body="ＦＬオングルリヌ+1", legs="ムセスサラウィル",feet="ＢＲスリッパー+3",})
    sets.midcast['BardSong'].Mambo      = set_combine(sets.midcast.song_base, {body="ＦＬオングルリヌ+1", legs="インヤガシャルワ+1", feet="ムセスクラッコー",})
    sets.midcast['BardSong'].Carol      = set_combine(sets.midcast.song_base, {body="ＦＬオングルリヌ+1", hands="ムセスゲージ", feet="ＢＲスリッパー+3",})
    sets.midcast['BardSong'].Minuet     = set_combine(sets.midcast.song_base, {body="ＦＬオングルリヌ+1", feet="ＢＲスリッパー+3",})
    sets.midcast['BardSong'].Madrigal   = set_combine(sets.midcast.song_base,{head="ＦＬキャロ+1", legs="インヤガシャルワ+2", back={ name="インタラアスケープ", augments={'Mag. Acc+20 /Mag. Dmg.+20','"Fast Cast"+10',}}})
    sets.midcast['BardSong'].Prelude    = set_combine(sets.midcast.song_base, {body="ＦＬオングルリヌ+1", feet="ＢＲスリッパー+3", back={ name="インタラアスケープ", augments={'Mag. Acc+20 /Mag. Dmg.+20','"Fast Cast"+10',}}})
    sets.midcast['BardSong'].March      = set_combine(sets.midcast.song_base, {hands="ＦＬマンシェト+1", legs="インヤガシャルワ+2", feet="ブリオソスリッパー",})
    sets.midcast['BardSong'].March_Marsyas = set_combine(sets.midcast['BardSong'].March, {range="マルシュアス",head="ＦＬキャロ+1",body="ＢＲジュスト+3", hand="ＦＬマンシェト+1",legs="インヤガシャルワ+2", feet="ＦＬコテュルヌ+1",left_ear="ブラギピアス", right_ear="デリングルピアス",})
    sets.midcast['BardSong'].Etude      = set_combine(sets.midcast.song_base, {head="ムセスターバン",body="ＦＬオングルリヌ+1", feet="ＢＲスリッパー+3",})
    sets.midcast['BardSong'].Scherzo    = set_combine(sets.midcast.song_base, {body="ＦＬオングルリヌ+1",legs="インヤガシャルワ+1", feet="ＦＬコテュルヌ+1",})
    ...
    sets.midcast['BardSong'].Sirvente = set_combine(sets.midcast.song_base, {body="ＦＬオングルリヌ+1",legs="インヤガシャルワ+1", feet="ブリオソスリッパー",})
    sets.midcast['BardSong'].Dirge = set_combine(sets.midcast.song_base, {body="ＦＬオングルリヌ+1", legs="インヤガシャルワ+1", feet="ブリオソスリッパー",})
    ...
    sets.idle = {
        ...
        right_ring="ＶＣリング+1",
        --back={ name="インタラアスケープ", augments={'CHR+20','Mag. Acc+20 /Mag. Dmg.+20','Mag. Acc.+10','"Fast Cast"+10','Damage taken-5%',}},
        --'Mag. Acc+20 /Mag. Dmg.+20','"Fast Cast"+10',
    }
