...
function get_sets()
    ...
    sets.aftercast.idle = {
        ...
        head={ name="テルキネキャップ", bag={'wardrobe',}},
        body="シャマシュローブ",
    ...
    sets.aftercast.idle_luopan = {
        ...
        --body="シャマシュローブ",
        body={ name="テルキネシャジュブ", },
        hands={ name="テルキネグローブ", bag={'wardrobe',}},
        legs={ name="テルキネブラコーニ", bag={'wardrobe',}},
        feet={ name="ＢＡサンダル+3", augments={'Enhances "Radial Arcana" effect',}},
        -- neck="ロリケートトルク+1",
        neck="バグアチャーム+2",
        -- waist="イーサベルト",
    ...
    -- マクロのブック, セット変更
    send_command('input /macro book 5; wait 0.5; input /macro set 1; wait 0.5; input /si geo; wait 0.5; input /lockstyleset 5 echo;')
...
function precast(spell)
    ...
    elseif spell.type == 'JobAbility' then
        ...
        elseif spell.name == 'メンドハレイション' then
            set_equip = {head={ name="ＢＡガレーロ+3", augments={'Enhances "Primeval Zeal" effect',}}, legs="ＢＡパンツ+1",}
